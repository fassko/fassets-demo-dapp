...
export interface GovernedOldContract
  extends Truffle.Contract<GovernedOldInstance> {
  "new"(
    _governance: string,
    meta?: Truffle.TransactionDetails
  ): Promise<GovernedOldInstance>;
}
...
export interface GovernedOldInstance extends Truffle.ContractInstance {
