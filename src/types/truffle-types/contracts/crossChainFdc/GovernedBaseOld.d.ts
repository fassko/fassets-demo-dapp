...
export interface GovernedBaseOldContract
  extends Truffle.Contract<GovernedBaseOldInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<GovernedBaseOldInstance>;
}
...
export interface GovernedBaseOldInstance extends Truffle.ContractInstance {
