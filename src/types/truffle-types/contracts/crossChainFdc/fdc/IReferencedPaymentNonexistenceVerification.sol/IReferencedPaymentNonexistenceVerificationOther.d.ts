...
export interface IReferencedPaymentNonexistenceVerificationOtherContract
  extends Truffle.Contract<IReferencedPaymentNonexistenceVerificationOtherInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<IReferencedPaymentNonexistenceVerificationOtherInstance>;
}

type AllEvents = never;

export interface IReferencedPaymentNonexistenceVerificationOtherInstance
