...
export interface INFTMinterContract
  extends Truffle.Contract<INFTMinterInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<INFTMinterInstance>;
}

type AllEvents = never;

export interface INFTMinterInstance extends Truffle.ContractInstance {
